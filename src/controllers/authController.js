...
var signUp = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email_1, password, existingUser, newUser;
    return __generator(this, function (_b) {
        try {
            ...
            newUser = { email: email_1, password: password };
            users.push(newUser);
...
var signIn = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email_2, password, user;
    return __generator(this, function (_b) {
        try {
            _a = req.body, email_2 = _a.email, password = _a.password;
            user = users.find(function (user) { return user.email === email_2; });
            if (!user) {
